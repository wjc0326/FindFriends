...
public class UserInteractionService {
    ...
    public void connectFriends(String name) {
        ...
        while (true) {
            ...
            if (friend.equals("Exit")) {
                ...
                System.out
                        .println("You can not enter yourself! Please enter a valid name.");
            } else if (rec.getThisUserInfo(database, friend).size() == 0) {
                System.out
                        .println("Friend doesn't exist. Please enter a valid name.");
            } else if (myFriends.contains(friend)) {
                System.out
                        .println(friend + " is already your friend! Get to know someone new!");
            } else {
                break;
            }
        }
        ...
        if (friendConnect.size() == 0) {
            System.out
                    .println("I am sorry. There is no way for you to connect to " + friend + ".");
            return;
        }

        System.out
                .print("There are " + (friendConnect.size() - 2) +
                        " people between you and " + friend + ".");
        System.out
                .print(" Inorder to know " + friend + ", you should get to know ");

        for (int i = 1; i < friendConnect.size() - 1; i++) {
            if (i == friendConnect.size() - 2) {
                System.out
                        .print(database.getUser(friendConnect.get(i)).getName());
            } else {
                System.out
                        .print(database.getUser(friendConnect.get(i)).getName() + ",");
            }
    ...
    public void findNewFriends(String name) {
        ...
        while (true) {
            ...
            if (wordList.contains(word)) {
                ...
                System.out
                        .println("The tags you choose are " + query + ".");
                break;
            } else {
                System.out
                        .println("Cannot recognize command or you have already choose this tag.");
            }
        }
        rec.getNewFriendsInfo(database, name);
        List<String> result = rec.newFriendsSorted(database, query);
        System.out
                .println("You may want to know them: " + result + "!");
    }
    ...
    public static String getString(String message) {
        ...
        while (true) {
            ...
            System.out
                    .println("An error has occurred, try again.");
        }
    }
    ...
    public void mainMenu(SocialDatabase database) {
        ...
        System.out
                .println("Welcome to Find Friends Social Network");
        System.out
                .println("There are already some profiles stored in the FriendBook " +
                        "that were loaded from serialized files.");
        System.out
                .println("Once you Exit, the modified hashedDictionaries will be " +
                        "displayed and reserialized (saved).");
    ...
    public void logIn(SocialDatabase database) {
        ...
        if (info.size() != 0) {
            // user profile
            System.out
                    .println("Here Is The User Profile :)");
            System.out
                    .println("User Name: " + username);
            System.out
                    .println("User Age: " + info.get("age"));
            System.out
                    .println("Hobby: " + info.get("hobby"));
            System.out
                    .println("Friends: " + info.get("friend"));
            ...
            while (control) {
                System.out
                        .println();
                System.out
                        .println("Hello " + username + "! What do you want to do today?");
                System.out
                        .println("1. Some one you may know");
                System.out
                        .println("2. Search friends and find how to connect them");
                System.out
                        .println("3. I want to log out :(");
